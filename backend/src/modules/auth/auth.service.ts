 ...
 */
export const verifyEmail = async (verifyEmailToken: any, verifyOtp: any): Promise<IUserDoc | null> => {
  try {
    const verifyEmailTokenDoc = await verifyToken(verifyEmailToken, tokenTypes.VERIFY_EMAIL, verifyOtp);
